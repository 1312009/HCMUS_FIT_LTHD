...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Hàu vọng nguyệt',N'Là món ăn vừa ngon, vừa bổ,
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Gà nướng bưởi xốt giấm',N'Gà nướng bưởi xốt giấm 
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Bún giò heo nấu giấm',N'Là món ăn lạ miệng và rất được ưa 
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Bún ốc',N'Bún ốc là một món ngon cân bằng dưỡng chất,
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Lẩu chua thịt bò',N'Lẩu chua thịt bò là món ăn ngon, 
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Súp nghêu rau củ',N'Món ăn này có xuất xứ từ món súp của các 
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Súp sắc màu',N'Một món ăn có nhiều sắc màu sẽ cũng cấp nhiều 
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Cá chiên hoa cúc',N'Đây là món ăn ngày Tết thật đơn
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Vịt kho nước tương',N'Vịt kho nước tương là món ăn 
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Chim cút nhồi cốm hấp',N'Là 1 món ăn ngon bổ dưỡng 
cho sức khỏe với các nguyên liệu','http://res.cloudinary.com/dqabuxewl/image/upload/v1480928954/5464_f3punz.jpg',3,30000,1,1)
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Nhộng rang lá chanh bắc',N'Mang hương vị đậm đà khi 
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Giò heo hầm bông atiso',N'Với tiêu chí món ăn ngon, 
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Vịt xốt chua ngọt',N'Với vịt quay, vịt luộc hay vịt xào sả ớt... 
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Cơm chiên xốt tương',N'Món ăn từ Nhật nhưng 
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Pha Chế Magarita Dưa Mix Bơ Lạ Miệng',N'Lại có thêm 
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Cật heo xào bí ngòi',N'Đây là món ăn ngon, với cật heo bổ
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Giò thủ xào',N'Món giò thủ là món ăn truyền thống rất 
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'BÚN BÒ HUẾ',N'Thịt bò xào lá lốt cũng là một món ngon 
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Tôm xào sả cay',N'Tôm xào sả cay là một món ăn ngon,
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Lươn xào lăn',N'Lươn xào lăn là một món ăn rất 
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Tôm rang ruốc tôm',N'Tôm rang ruốc tôm là món ngon, 
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Bánh tét lá cẩm',N'Bánh tét lá cẩm là món bánh truyền thống 
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Bánh há cảo hoa hồng',N'Là món bánh quen thuộc 
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Gỏi trứng chiên','Gỏi trứng chiên có nguồn gốc 
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Gỏi gà rau răm',N'Món gỏi có vị rất đậm đà 
...
INSERT INTO FOOD(NAME,DECRIPTION,IMGFOOD,IDTYPE,PRICE,ISSALE,NUMBER) VALUES (N'Nộm hoa chuối hải sản',
...
go
--Load danh sách top các món ăn được đặt hàng nhiều nhất trong ngày
CREATE PROCEDURE usp_LoaiMonAn @TYPE INT
AS
BEGIN
	SELECT F.ID,F.NAME,F.DECRIPTION,F.ISSALE,F.IDTYPE,F.IMGFOOD,F.PRICE,F.NUMBER
...
GO
--THÊM MÓN ĂN
CREATE PROCEDURE usp_ThemMonAn @name nvarchar(100), @decription nvarchar(500),@issale int,
...
go
--xóa món ăn
CREATE PROCEDURE usp_XoaMonAn @id int
as
begin
